...
if fso.folderExists(currentfolder+"\data") then
	...
	if fso.GetFile(currentfolder+"\data\sign.txt").size>10000 and fso.GetFile(currentfolder+"\data\folder.txt").size>10000  and fso.GetFile(currentfolder+"\data\AppdataInfo.txt").size >400 then
		msgbox "更新完成！"
	else
